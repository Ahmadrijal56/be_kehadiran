...
import { getBootstrapStatus, registerOwner, } from "../../services/ownerRegistrationService.js";
export const authRouter = Router();
authRouter.get("/bootstrap-status", asyncHandler(async (_req, res) => {
    res.json({ data: await getBootstrapStatus() });
}));
authRouter.post("/register-owner", loginRateLimit, asyncHandler(async (req, res) => {
