...
export async function downloadAndStoreTelegramPhoto(fileId, keyPrefix) {
    ...
    try {
        const fileRes = await fetch(`https://api.telegram.org/bot${env.telegramBotToken}/getFile?file_id=${encodeURIComponent(fileId)}`);
        if (!fileRes.ok)
...
//# sourceMappingURL=telegramPhotoService.js.map