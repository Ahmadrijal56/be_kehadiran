...
export async function processForgotCheckoutsForDate(workDate) {
...
export async function processYesterdayForgotCheckouts() {
    const today = todayWorkDateWib();
    const yesterday = new Date(today);
    yesterday.setUTCDate(yesterday.getUTCDate() - 1);
    return processForgotCheckoutsForDate(yesterday);
}
//# sourceMappingURL=forgotCheckoutService.js.map